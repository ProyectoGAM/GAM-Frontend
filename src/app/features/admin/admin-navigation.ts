...
export const ADMIN_NAVIGATION: readonly AdminNavigationGroup[] = [
  ...
  { id: 'ubicaciones', label: 'Ubicaciones', icon: 'location-outline', items: [{ label: 'Unidades productivas', slug: 'unidades-productivas' }, { label: 'Crear unidad productiva', slug: 'nueva-unidad-productiva' }, { label: 'Galpones', slug: 'galpones' }, { label: 'Crear galpón', slug: 'nuevo-galpon' }, { label: 'Plantas de ración', slug: 'plantas-de-racion' }] },
