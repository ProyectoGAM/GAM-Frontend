...
@Component({
  ...
  template: `<main class="future-page"><h1>Detalle de instalación</h1><p>Esta pantalla se implementará en una etapa futura.</p><ion-button [routerLink]="['/administracion/ubicaciones/unidades-productivas', unitId]">Volver a la unidad productiva</ion-button></main>`,
